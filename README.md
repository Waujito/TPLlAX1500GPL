...
Here's the GPL binaries built by [Github Actions](https://github.com/Waujito/TPLlAX1500GPL/actions/workflows/build-gpl.yml) available. Note, that you'll want to run this inside the docker image with ubuntu 12.04 anyway.
